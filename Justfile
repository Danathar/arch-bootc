...
lint:
    ...
    shellcheck system_files/usr/bin/ostree-pkg-diff system_files/usr/libexec/arch-bootc-prune-esp scripts/quickstart.sh scripts/pr-review-state.sh scripts/prune-package-versions.sh tests/run-tests.sh tests/check-coverage.sh tests/check-invariants.sh tests/tune-coverage.sh tests/test-prune-esp.sh tests/test-ostree-pkg-diff.sh tests/test-ostree-pkg-diff-db.sh tests/test-pr-review-state.sh tests/test-prune-package-versions.sh tests/test-quickstart-baremetal.sh tests/e2e/test-quickstart-dry-run.sh
