...
## Create QCOW2 From GHCR (No Local Build)

Use this path if you want to create a VM disk image from your already-published GHCR image and skip local `Containerfile` builds.
